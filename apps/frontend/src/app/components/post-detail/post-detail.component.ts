...
@Component({
  ...
  template: `
    ...
    <article *ngIf="post && !isLoading && !error" class="min-h-screen">
      <!-- Hero Section -->
      <header
        class="bg-gradient-to-r from-gray-900 via-blue-900 to-gray-900 text-white py-16 lg:py-24"
      >
          ...
          <div class="text-center">
            ...
            <nav class="mb-8">
              <ol class="flex items-center justify-center space-x-2 text-sm">
                <li>
                  <a routerLink="/" class="text-gray-300 hover:text-white transition-colors"
                    >Home</a
                  >
                </li>
            ...
            <div class="flex items-center justify-center space-x-6 text-gray-300 mb-8">
              ...
              <div class="flex items-center">
                <span
                  class="px-3 py-1 bg-blue-600 bg-opacity-20 text-blue-200 text-sm font-medium rounded-full"
                >
      ...
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
          <div class="px-6 sm:px-10 lg:px-12 py-8 sm:py-12">
            <!-- Content -->
            <div class="prose prose-lg prose-blue max-w-none" [innerHTML]="getContentHtml()"></div>
    ...
    for (const node of children) {
      switch (node.type) {
        ...
        case 'link':
          html += `<a href="${
            node.url
          }" target="_blank" rel="noopener noreferrer">${this.convertLexicalToHtml(
            node.children || []
          )}</a>`;
          break;
        case 'quote':
